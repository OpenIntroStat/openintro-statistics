...
\begin{center}
\includegraphics[width=0.42\textwidth]{ch_regr_simple_linear/figures/eoce/resDemo1/resDemoLin.pdf} 
\includegraphics[width=0.42\textwidth]{ch_regr_simple_linear/figures/eoce/resDemo1/resDemoFanBack.pdf}
\end{center}
}{}
...
\begin{center}
\includegraphics[width=0.42\textwidth]{ch_regr_simple_linear/figures/eoce/resDemo2/resDemoResScatFan.pdf} 
\includegraphics[width=0.42\textwidth]{ch_regr_simple_linear/figures/eoce/resDemo2/resDemoResScatExp.pdf}
\end{center}
}{}
...
\begin{center}
\includegraphics[width=0.32\textwidth]{ch_regr_simple_linear/figures/eoce/association/association1.pdf}
\includegraphics[width=0.32\textwidth]{ch_regr_simple_linear/figures/eoce/association/association2.pdf}
\includegraphics[width=0.32\textwidth]{ch_regr_simple_linear/figures/eoce/association/association3.pdf}
\includegraphics[width=0.32\textwidth]{ch_regr_simple_linear/figures/eoce/association/association4.pdf}
\includegraphics[width=0.32\textwidth]{ch_regr_simple_linear/figures/eoce/association/association5.pdf}
\includegraphics[width=0.32\textwidth]{ch_regr_simple_linear/figures/eoce/association/association6.pdf}
\end{center}
}{}

% 4

\eoce{\qt{Identify relationships, Part II} For each of the six plots, identify the strength of the relationship (e.g. weak, moderate, or strong) in the data and whether fitting a linear model would be reasonable.
\begin{center}
\includegraphics[width=0.32\textwidth]{ch_regr_simple_linear/figures/eoce/association/association7.pdf}
\includegraphics[width=0.32\textwidth]{ch_regr_simple_linear/figures/eoce/association/association8.pdf}
\includegraphics[width=0.32\textwidth]{ch_regr_simple_linear/figures/eoce/association/association9.pdf}
\includegraphics[width=0.32\textwidth]{ch_regr_simple_linear/figures/eoce/association/association10.pdf}
\includegraphics[width=0.32\textwidth]{ch_regr_simple_linear/figures/eoce/association/association11.pdf}
\includegraphics[width=0.32\textwidth]{ch_regr_simple_linear/figures/eoce/association/association12.pdf}
\end{center}
}{}
...
\end{parts}
\begin{center}
\includegraphics[width=0.49\textwidth]{ch_regr_simple_linear/figures/eoce/exam/final_exam1.pdf}\ \ 
\includegraphics[width=0.49\textwidth]{ch_regr_simple_linear/figures/eoce/exam/final_exam2.pdf}
\end{center}
}{}
...
\begin{center}
\includegraphics[width=0.38\textwidth]{ch_regr_simple_linear/figures/eoce/husbandsWives/husbandsWives_age} \hspace{5mm}
\includegraphics[width=0.38\textwidth]{ch_regr_simple_linear/figures/eoce/husbandsWives/husbandsWives_height}
\end{center}
\begin{parts}
...
\begin{center}
\includegraphics[width=0.45\textwidth]{ch_regr_simple_linear/figures/eoce/corrMatch/corrMatch1.pdf}
\includegraphics[width= 0.45\textwidth]{ch_regr_simple_linear/figures/eoce/corrMatch/corrMatch2.pdf} \\
\includegraphics[width= 0.45\textwidth]{ch_regr_simple_linear/figures/eoce/corrMatch/corrMatch3.pdf}
\includegraphics[width= 0.45\textwidth]{ch_regr_simple_linear/figures/eoce/corrMatch/corrMatch4.pdf}
\end{center}
\end{minipage}
...
\begin{minipage}[c]{0.57\textwidth}
\begin{center}
\includegraphics[width=0.45\textwidth]{ch_regr_simple_linear/figures/eoce/corrMatch/corrMatch5.pdf}
\includegraphics[width= 0.45\textwidth]{ch_regr_simple_linear/figures/eoce/corrMatch/corrMatch6.pdf} \\
\includegraphics[width= 0.45\textwidth]{ch_regr_simple_linear/figures/eoce/corrMatch/corrMatch7.pdf}
\includegraphics[width= 0.45\textwidth]{ch_regr_simple_linear/figures/eoce/corrMatch/corrMatch8.pdf}
\end{center}
\end{minipage}
...
% 9
\eoce{\qt{True / False} Determine if the following statements are true or false. If false, explain why.
\begin{parts}
\item A correlation coefficient of -0.90 indicates a stronger linear relationship than a correlation coefficient of 0.5.
...
\eoce{\qt{Guess the correlation} Eduardo and Rosie are both collecting data on number of rainy days in a year and the total rainfall for the year. Eduardo records rainfall in inches and Rosie in centimeters. How will their correlation coefficients compare?
}{}
...
\begin{center}
\includegraphics[width=0.485\textwidth]{ch_regr_simple_linear/figures/eoce/speed/speed_height}\hspace{0.02\textwidth}%
\includegraphics[width=0.485\textwidth]{ch_regr_simple_linear/figures/eoce/speed/speed_height_gender}
\end{center}
\begin{parts}
...
\begin{center}
\includegraphics[width=0.485\textwidth]{ch_regr_simple_linear/figures/eoce/trees/height_vol}\hspace{0.02\textwidth}%
\includegraphics[width=0.485\textwidth]{ch_regr_simple_linear/figures/eoce/trees/girth_vol}
\end{center}
\begin{parts}
...
\includegraphics[width=\textwidth]{ch_regr_simple_linear/figures/eoce/coastStarlight/coastStarScat}
\end{minipage}
}{}
...
\end{minipage}
\begin{minipage}[c]{0.52\textwidth}
\includegraphics[width=\textwidth]{ch_regr_simple_linear/figures/eoce/babiesCrawl/babiesCrawl}
\end{minipage}
}{}
...
\end{minipage}
\begin{minipage}[c]{0.52\textwidth}
\includegraphics[width=\textwidth]{ch_regr_simple_linear/figures/eoce/bodyMeas/bodyHgtShoGi}
\end{minipage}
}{}
...
\end{minipage}
\begin{minipage}[c]{0.52\textwidth}
\includegraphics[width=\textwidth]{ch_regr_simple_linear/figures/eoce/bodyMeas/bodyWgtHipGi}
\end{minipage}
}{}
...
% 19
\eoce{\qt{Units of regression} Consider a regression predicting weight (kg) from height (cm) for a sample of adult males. What are the units of the correlation coefficient, the intercept, and the slope?
}{}

% 20
\eoce{\qtq{Which is higher} Determine if I or II is higher or if they are equal. Explain your reasoning.

\noindent For a regression line, the uncertainty associated with the slope estimate, $b_1$, is higher when
\begin{enumerate}
...
% 21
\eoce{\qt{Over-under, Part I} Suppose we fit a regression line to predict the shelf life of an apple based on its weight. For a particular apple, we predict the shelf life to be 4.6 days. The apple's residual is -0.6 days. Did we over or under estimate the shelf-life of the apple? Explain your reasoning.
}{}

% 22
\eoce{\qt{Over-under, Part II} Suppose we fit a regression line to predict the number of incidents of skin cancer per 1,000 people from the number of sunny days in a year. For a particular year, we predict the incidence of skin cancer to be 1.5 per 1,000 people, and the residual for this year is 0.5. Did we over or under estimate the incidence of skin cancer? Explain your reasoning.
}{}
...
\begin{center}
\includegraphics[width=0.32\textwidth]{ch_regr_simple_linear/figures/eoce/tourism/tourism_scat}
\includegraphics[width=0.32\textwidth]{ch_regr_simple_linear/figures/eoce/tourism/tourism_res_scat}
\includegraphics[width=0.32\textwidth]{ch_regr_simple_linear/figures/eoce/tourism/tourism_res_hist}
\end{center}
\begin{parts}
...
\begin{center}
\includegraphics[width=0.32\textwidth]{ch_regr_simple_linear/figures/eoce/starbucks/carb_cals_scat}
\includegraphics[width=0.32\textwidth]{ch_regr_simple_linear/figures/eoce/starbucks/carb_cals_res_scat}
\includegraphics[width=0.32\textwidth]{ch_regr_simple_linear/figures/eoce/starbucks/carb_cals_res_hist}
\end{center}
\begin{parts}
...
\item It actually takes the Coast Starlight about 168 mins to travel from Santa Barbara to Los Angeles. Calculate the residual and explain the meaning of this residual value.
...
\eoce{\qt{Body measurements, Part III} \label{bodyHgtShoGiReg} Exercise~\ref{bodyHgtShoGi} introduces data on shoulder girth and height of a group of individuals. The mean shoulder girth is 107.20 cm with a standard deviation of 10.37 cm. The mean height is 171.14 cm with a standard deviation of 9.41 cm. The correlation between height and shoulder girth is 0.67.
\begin{parts}
...
\begin{minipage}[c]{0.4\textwidth}
\begin{center}
\includegraphics[width= \textwidth]{ch_regr_simple_linear/figures/eoce/starbucks/pro_cals} \\
\end{center}
\end{minipage}
...
\begin{center}
\includegraphics[width= \textwidth]{ch_regr_simple_linear/figures/eoce/helmet/lunch_helmet} \\
\end{center}
\end{minipage}
}{}
...
\eoce{\qt{Murders and poverty, Part I} \label{murderPoverty} The following regression output is for predicting annual murders per million from percentage living in poverty in a random sample of 20 metropolitan areas.\\[2mm]
...
\end{minipage}
\begin{minipage}[c]{0.4\textwidth}
\includegraphics[width=0.99\textwidth]{ch_regr_simple_linear/figures/eoce/murder/annual_murders_per_mil_perc_pov}
\end{minipage}
}{}

% 30

\eoce{\qt{Cats, Part I} \label{cats} The following regression output is for predicting the heart weight (in g) of cats from their body weight (in kg). The coefficients are estimated using a dataset of 144 domestic cats.\\[2mm]
\begin{minipage}[c]{0.55\textwidth}
{\small
\begin{tabular}{rrrrr}
  \hline
...
\end{minipage}
\begin{minipage}[c]{0.4\textwidth}
\includegraphics[width=0.99\textwidth]{ch_regr_simple_linear/figures/eoce/cats/heart_body}
\end{minipage}
}{}
...
\begin{center}
\includegraphics[width=0.32\textwidth]{ch_regr_simple_linear/figures/eoce/outliers/outInf1.pdf}
\includegraphics[width=0.32\textwidth]{ch_regr_simple_linear/figures/eoce/outliers/outLev1.pdf}
\includegraphics[width=0.32\textwidth]{ch_regr_simple_linear/figures/eoce/outliers/outOut1.pdf}
\end{center}
}{}
...
\begin{center}
\includegraphics[width=0.32\textwidth]{ch_regr_simple_linear/figures/eoce/outliers/outInf2.pdf}
\includegraphics[width=0.32\textwidth]{ch_regr_simple_linear/figures/eoce/outliers/outInf3.pdf}
\includegraphics[width=0.32\textwidth]{ch_regr_simple_linear/figures/eoce/outliers/outOut2.pdf}
\end{center}
}{}
...
\end{minipage}
\begin{minipage}[c]{0.4\textwidth}
\includegraphics[width=0.95\textwidth]{ch_regr_simple_linear/figures/eoce/urbanOwner/urbanOwner_withDC.pdf} \vspace{-3mm}
\end{minipage}
}{}
...
\begin{minipage}[c]{0.4\textwidth}
\begin{center}
\includegraphics[width=\textwidth]{ch_regr_simple_linear/figures/eoce/bodyMeas/bodyWgtHgt}
\end{center}
\end{minipage}
...
\begin{minipage}[c]{0.4\textwidth}
\begin{center}
\includegraphics[width=0.76\textwidth]{ch_regr_simple_linear/figures/eoce/bac/bloodAlc.pdf}
\end{center}
\end{minipage}
\begin{minipage}[c]{0.6\textwidth}
{\scriptsize
...
\eoce{\qt{Husbands and wives, Part III} \label{husbandsWivesAgeModel} Exercise~\ref{husbandsWives} presents a scatterplot displaying the relationship between husbands' and wives' ages in a random sample of 170 married couples in Britain, where both partners' ages are below 65 years. Given below is summary output of the least squares fit for predicting wife's age from husband's age.

\begin{minipage}[c]{0.4\textwidth}
\begin{center}
\includegraphics[width=\textwidth]{ch_regr_simple_linear/figures/eoce/husbandsWives/husbandsWives_age}
\end{center}
\end{minipage}
\begin{minipage}[c]{0.6\textwidth}
{\scriptsize
...
\eoce{\qt{Urban homeowners, Part II} \\
\noindent \begin{minipage}[c]{0.56\textwidth}
Exercise~\ref{urbanOwner} gives a scatterplot displaying the relationship between the percent of families that own their home and the percent of the population living in urban areas. Below is a similar scatterplot, excluding District of Columbia, as well as the residuals plot. There were 51 cases.
\begin{parts}
...
\begin{minipage}[c]{0.4\textwidth}
\begin{center}
\includegraphics[width=\textwidth]{ch_regr_simple_linear/figures/eoce/urbanOwner/urbanOwner_withoutDC}
\end{center}
\end{minipage}
}{}
...
\noindent\begin{minipage}[c]{0.4\textwidth}
\includegraphics[width=\textwidth]{ch_regr_simple_linear/figures/eoce/prof/beauty_eval} \\
\end{minipage}
\begin{minipage}[c]{0.6\textwidth}
\begin{tabular}{rrrrr}
  \hline
...
\item List the conditions required for linear regression and check if each one is satisfied for this model based on the following diagnostic plots.
\begin{center}
\includegraphics[width=0.4\textwidth]{ch_regr_simple_linear/figures/eoce/prof/beauty_eval_res}
\includegraphics[width=0.4\textwidth]{ch_regr_simple_linear/figures/eoce/prof/beauty_eval_res_hist} \\
\includegraphics[width=0.4\textwidth]{ch_regr_simple_linear/figures/eoce/prof/beauty_eval_res_qq}
\includegraphics[width=0.4\textwidth]{ch_regr_simple_linear/figures/eoce/prof/beauty_eval_res_order}
\end{center}
\end{parts}
}{}
...
\eoce{\qt{Murders and poverty, Part II} \label{murderPoverty2} Exercise~\ref{murderPoverty} presents regression output from a model for predicting annual murders per million from percentage living in poverty based on a random sample of 20 metropolitan areas. The model output is also provided below.
\begin{center}
\begin{tabular}{rrrrr}
  \hline
 & Estimate & Std. Error & t value & Pr($>$$|$t$|$) \\ 
...
\end{center}
\begin{parts}
\item What are the hypotheses for evaluating whether poverty percentage is a significant predictor of murder rate?
\item State the conclusion of the hypothesis test from part (a) in context of the data.
...
\eoce{\qt{Murders and poverty, Part III} In Exercises~\ref{murderPoverty2} you evaluated whether poverty percentage is a significant predictor of murder rate. How, if at all, would your answer change if we wanted to find out whether poverty percentage is positively associated with murder rate. Make sure to include the appropriate p-value for this hypothesis test in your answer.
}{}

% 44

\eoce{\qt{Cats, Part II} Exercise~\ref{cats} presents regression output from a model for predicting the heart weight (in g) of cats from their body weight (in kg). The coefficients are estimated using a dataset of 144 domestic cats. The model output is also provided below.
\begin{center}
\begin{tabular}{rrrrr}
  \hline
 & Estimate & Std. Error & t value & Pr($>$$|$t$|$) \\ 
...
\end{center}
\begin{parts}
\item What are the hypotheses for evaluating whether body weight is positively associated with heart weight in cats? 
\item State the conclusion of the hypothesis test from part (a) in context of the data.
\item Calculate a 95\% confidence interval for the slope of body weight, and interpret it in context of the data.
\item Do your results from the hypothesis test and the confidence interval agree? Explain.
\end{parts}
}{}
