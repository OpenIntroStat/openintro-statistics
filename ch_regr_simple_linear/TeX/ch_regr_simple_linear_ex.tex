...
\begin{center}
\includegraphics[width=0.4\textwidth]{ch_regr_simple_linear/figures/eoce/husbandsWives/husbandsWives_age} \hspace{5mm}
\includegraphics[width=0.4\textwidth]{ch_regr_simple_linear/figures/eoce/husbandsWives/husbandsWives_height}
\end{center}
\begin{parts}
...
\includegraphics[width=\textwidth]{ch_regr_simple_linear/figures/eoce/tourism/tourism_scat}
\end{minipage}\hspace{5mm}%
\begin{minipage}[c]{0.4\textwidth}
\includegraphics[width=\textwidth]{ch_regr_simple_linear/figures/eoce/tourism/tourism_resHist}
\end{minipage}
\end{center}
}{}
...
\includegraphics[width=\textwidth]{ch_regr_simple_linear/figures/eoce/starbucks/carb_cals}
\end{minipage}\hspace{5mm}%
\begin{minipage}[c]{0.4\textwidth}
\includegraphics[width=\textwidth]{ch_regr_simple_linear/figures/eoce/starbucks/carb_cals_res_hist}
\end{minipage}
\end{center}
}{}
...
\begin{minipage}[c]{0.4\textwidth}
\begin{center}
\includegraphics[width= \textwidth]{ch_regr_simple_linear/figures/eoce/gradesTV/gradesTV} \\
\end{center}
\end{minipage} \\[4mm]
...
\begin{minipage}[c]{0.4\textwidth}
\begin{center}
\includegraphics[width=57mm]{ch_regr_simple_linear/figures/eoce/bac/bloodAlc.pdf}
\end{center}
\end{minipage}
...
\begin{center}
\includegraphics[width=\textwidth]{ch_regr_simple_linear/figures/eoce/husbandsWives/husbandsWives_height}
\end{center}
\end{minipage}
\begin{minipage}[c]{0.6\textwidth}
{\scriptsize
...
\begin{center}
\includegraphics[width=0.9\textwidth]{ch_regr_simple_linear/figures/eoce/prof/beauty_eval} \\
\end{center}
\end{minipage}

\begin{center}
\includegraphics[width=0.47\textwidth]{ch_regr_simple_linear/figures/eoce/prof/beauty_eval_res}
\includegraphics[width=0.47\textwidth]{ch_regr_simple_linear/figures/eoce/prof/beauty_eval_res_hist} \\
\includegraphics[width=0.47\textwidth]{ch_regr_simple_linear/figures/eoce/prof/beauty_eval_res_qq}
\includegraphics[width=0.47\textwidth]{ch_regr_simple_linear/figures/eoce/prof/beauty_eval_res_order}
\end{center}
