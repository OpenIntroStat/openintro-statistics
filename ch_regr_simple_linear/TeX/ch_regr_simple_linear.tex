...
\section%[Line fitting, residuals, and correlation]
    {Line fitting, residuals, and correlation}% \sectionvideohref{youtube-mPvtZhdPBhQ&list=PLkIselvEzpM63ikRfN41DNIhSgzboELOM}~\sectionslideshref{gdoc_os3_slides_7-1}}
...
\section%[Fitting a line by least squares regression]
    {Fitting a line by least squares regression}% \sectionvideohref{youtube-z8DmwG2G4Qc&list=PLkIselvEzpM63ikRfN41DNIhSgzboELOM}~\sectionslideshref{gdoc_os3_slides_7-2}}
...
\section%[Types of outliers in linear regression]
    {Types of outliers in linear regression}% \sectionvideohref{youtube-jZEKAlo1E54&list=PLkIselvEzpM63ikRfN41DNIhSgzboELOM}~\sectionslideshref{gdoc_os3_slides_7-3}}
...
{Inference for linear regression}% \sectionvideohref{youtube-depiT-hTaGA&list=PLkIselvEzpM63ikRfN41DNIhSgzboELOM}~\sectionslideshref{gdoc_os3_slides_7-4}}
