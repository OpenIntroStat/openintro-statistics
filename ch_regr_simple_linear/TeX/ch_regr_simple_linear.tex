...
\begin{examplewrap}
\begin{nexample}{What do the first and second columns of Figure~\ref{midtermElectionUnemploymentRRegressionOutput} represent?}
...
\begin{examplewrap}
\begin{nexample}{Figure~\ref{midtermElectionUnemploymentRRegressionOutput} offers the degrees of freedom for the test statistic $T$: $df=25$. Identify the p-value for the hypothesis test.}
