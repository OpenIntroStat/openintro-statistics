...
\begin{center}
\includegraphics[width=0.45\textwidth]{ch_regr_simple_linear/figures/eoce/match_corr_3/scatter_1}
\includegraphics[width=0.45\textwidth]{ch_regr_simple_linear/figures/eoce/match_corr_3/scatter_2} \\
\includegraphics[width=0.45\textwidth]{ch_regr_simple_linear/figures/eoce/match_corr_3/scatter_3}
\includegraphics[width=0.45\textwidth]{ch_regr_simple_linear/figures/eoce/match_corr_3/scatter_4}
\end{center}
\end{minipage}
}{}
