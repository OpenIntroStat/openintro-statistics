...
The open data portal of the city of 
Seattle, WA has a dataset of pets registered in the city. For each registered 
pet we have information on their name and their species. The following 
visualization plots the proportion of dogs with a given name versus the 
proportion of cats with the same name. 20 most common cat and dog names are 
displayed. The diagonal line on the plot is the $x = y$ line, meaning that if 
a name appeared on this line its popularity would be exactly the same for dogs 
and cats.

\noindent\begin{minipage}[c]{0.44\textwidth}
\begin{parts}
\item Are these data collected as part of an experiment or an observational 
study?
\item What is the most common dog name? What is the most common cat name?
\item What names are more common for cats than dogs?
\item Is the relationship between the two variable positive or negative? 
What does this mean in context of the data?
\end{parts}
\end{minipage}
\begin{minipage}[c]{0.55\textwidth}
\begin{center}
\includegraphics[width = 0.78\textwidth]{ch_intro_to_data/figures/eoce/seattle_pet_names/seattle_pet_names.pdf}
\end{center}
\end{minipage}
}{}
