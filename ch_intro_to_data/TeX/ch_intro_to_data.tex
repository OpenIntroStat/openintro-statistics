...
\section[Case study: using stents to prevent strokes]
    {Case study: using stents\\to prevent strokes}% \sectionvideohref{youtube-nEHFF1ADpWE&list=PLkIselvEzpM6pZ76FD3NoCvvgkj_p-dE8} \sectionslideshref{gdoc_os3_slides_1-1}}
