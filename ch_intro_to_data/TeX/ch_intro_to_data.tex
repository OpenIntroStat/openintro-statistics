...
% Croatian
\chapterintro{%
	Znanstvenici traže odgovore na pitanja
...
Te ćemo opservacije zvati skup podataka \data{loan50}.
...
% Croatian
Svaki redak u tablici predstavlja jedan kredit. Stručno ime za redak je \term{jedinica opažanja} ili \term{pokusna jedinica} ili \term{opservacija}. Stupci predstavljaju svojstva i nazivamo ih \termsub{varijablama}{varijabla} za svaki kredit.
...
% Croatian
\footnotetext{Ocjena kredita je A, a zajmoprimac živi u iznajmljenom stanu.}

% English
%\footnotetext{The loan's grade is A, and the borrower rents their residence.}

% Croatian
U praksi je posebno važno postavljati pitanja kako bismo razjasnili i potpuno razumjeli važne aspekte podataka. Na primjer, uvijek je važno biti siguran u točno značenje svake varijable i u korištene mjerne jedinice. Opis varijabli u tablici podataka \data{loan50} prikazan je na Slici~\ref{loan50Variables}.
...
\caption{Četiri retka matrice podataka \data{loan50}.}\label{loan50DF}
\end{figure}
...
\begin{figure}[h]
	...
	\begin{tabular}{lp{10.5cm}}
		...
		\hline
	\end{tabular}
	\caption{Varijable u skupu podataka \data{loan50} i njihov opis.}
