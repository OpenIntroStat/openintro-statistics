...
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth]{ch_intro_to_data/figures/samplingMethodsFigure/samplingMethodsFigure}
...
\textB{\setlength{\captionwidth}{0.885\textwidth}}

\begin{figure}[h]
   \centering
   \includegraphics[width=0.75\textwidth]{ch_intro_to_data/figures/email50LinesCharacters/email50LinesCharacters}
...
\textB{\setlength{\captionwidth}{\mycaptionwidth}}
...
\begin{figure}[h]
   \centering
   \includegraphics[width=0.65\textwidth]{ch_intro_to_data/figures/carsPriceVsWeight/carsPriceVsWeight}
...
Sometimes two variables is one too many: only one variable may be of interest. In these cases, a dot plot provides the most basic of displays. A~\term{dot plot} is a one-variable scatterplot; an example using the number of characters from 50 emails is shown in Figure~\ref{emailCharactersDotPlot}. A stacked version of this dot plot\Add{, where the number of characters for each email has been rounded to the nearest 2,000,} is shown in Figure~\ref{emailCharactersDotPlotStacked}.
...
\Comment{Figure~\ref{emailCharactersDotPlotStacked} has an updated caption.}
...
\begin{figure}
\centering
\includegraphics[width=0.63\textwidth]{ch_intro_to_data/figures/severalDiffDistWithSdOf1/severalDiffDistWithSdOf1}
...
\begin{figure}[h]
   \centering
   \includegraphics[width=0.87\mycaptionwidth]{ch_intro_to_data/figures/boxPlotLayoutNumVar/boxPlotLayoutNumVar}
...
\centering
\subfigure[]{
\includegraphics[width=0.46\textwidth]{ch_intro_to_data/figures/email50LinesCharactersMod/email50LinesCharactersMod}
\label{email50LinesCharactersMod}
}
\subfigure[]{
\includegraphics[width=0.46\textwidth]{ch_intro_to_data/figures/email50LinesCharactersMod/email50LinesCharactersModLog}
...
\begin{figure}[bht]
   \centering
   \includegraphics[height=2.3in]{ch_intro_to_data/figures/emailNumberBarPlot/emailNumberBarPlot}
...
\centering
\subfigure[]{
\includegraphics[width=0.4034\textwidth]{ch_intro_to_data/figures/emailSpamNumberMosaicPlot/emailNumberMosaic}
\label{emailNumberMosaic}
}
\subfigure[]{
\includegraphics[width=0.4706\textwidth]{ch_intro_to_data/figures/emailSpamNumberMosaicPlot/emailSpamNumberMosaic}
...
\begin{figure}
   \centering
   \includegraphics[width=0.45\textwidth]{ch_intro_to_data/figures/emailSpamNumberMosaicPlot/emailSpamNumberMosaicRev}
