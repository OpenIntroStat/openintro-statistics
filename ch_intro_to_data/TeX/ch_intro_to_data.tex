...
\begin{tabular}{ccc ccc cc} %c}
  \hline
   & loan\_amount & interest\_rate & term & grade & state
       & total\_income & home\_ownership \\ % & verified\_income \\ 
  \hline
  1 & 7500 & 7.34 & 36.00 & A & MD & 70000.00 & RENT \\ % & Source Verified \\ 
  2 & 25000 & 9.43 & 60.00 & B & OH & 254000.00 & MORTGAGE \\ % & Not Verified \\ 
  3 & 14500 & 6.08 & 36.00 & A & MO & 80000.00 & MORTGAGE \\ % & Not Verified \\ 
  $\vdots$ & $\vdots$ & $\vdots$ & $\vdots$ & $\vdots$ & $\vdots$
      & $\vdots$ & $\vdots$ \\ % & $\vdots$ \\
  50 & 3000 & 7.96 & 36.00 & A & CA & 34000.00 & RENT \\ % & Not Verified \\ 
   \hline
\end{tabular}
}
...
What is an efficient way to store organize the data
...
%Figure~\ref{interest_rate_vs_income} compares the variables
%\var{interest\_\hspace{0.3mm}rate}
...
%Loan~40 in the \data{loan50} data set: a borrower
%who had an income of \$160,000 and received an interest
%rate of 12.62\%.
%Other details of the loan include that it was for \$38,000,
%the borrower has a mortgage, and the loan received a grade of C.
...
then income is the \termsub{explanatory}{explanatory variable}
