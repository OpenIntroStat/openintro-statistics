...
\hline
\end{tabular}
\caption{Variables and their descriptions for the \data{email50} data set.\textB{\vspace{-3.5mm}}}
...
\Comment{Cluster sampling was corrected, and what was called ``cluster sampling'' before is now called ``multistage sampling''.}
