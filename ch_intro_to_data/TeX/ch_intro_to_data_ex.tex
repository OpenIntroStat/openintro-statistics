...
\begin{center}
\includegraphics[width = 0.75\textwidth]{ch_intro_to_data/figures/eoce/images/earacupuncture}
\end{center}
\end{minipage}
...
\begin{center}
\includegraphics[width = 30mm]{ch_intro_to_data/figures/eoce/images/irisversicolor}
\end{center}
\end{minipage}
}{}
...
\begin{center}
\includegraphics[width = 0.88\textwidth]{ch_intro_to_data/figures/eoce/gpaStudy/gpaStudy}
\end{center}
\end{minipage}
}{}
...
\begin{minipage}[c]{0.55\textwidth}
\begin{center}
\includegraphics[width = 0.88\textwidth]{ch_intro_to_data/figures/eoce/county/county_incomeBach}
\end{center}
\end{minipage}
}{}
...
\hfill\includegraphics[width = 0.95\textwidth]{ch_intro_to_data/figures/eoce/country/county_lifeExpInter}
\end{minipage}
}{}
...
\begin{center}
\includegraphics[width = 60mm]{ch_intro_to_data/figures/eoce/mammals/mammals_lifeSpanGest}
\end{center}
\end{minipage}
}{}
...
\hfill\includegraphics[width = 0.95\textwidth]{ch_intro_to_data/figures/eoce/associationPlots/associationPlots}
\end{minipage}
}{}
...
\begin{center}
\includegraphics[width = 0.7\textwidth]{ch_intro_to_data/figures/eoce/smoking/smoking_amountHist}
\end{center}
}{}
...
\hfill\includegraphics[width = 0.95\textwidth]{ch_intro_to_data/figures/eoce/country/country_infMort}
\end{minipage}
}{}
...
\begin{center}
\includegraphics[width =\textwidth]{ch_intro_to_data/figures/eoce/histBoxMatch/histBoxMatch}
\end{center}
}{}
...
\begin{center}
\includegraphics[width = 0.75\textwidth]{ch_intro_to_data/figures/eoce/durhamAQI/durhamAQI_hist} 
\end{center}
\begin{parts}
...
\begin{center}
\includegraphics[width = 0.77\textwidth]{ch_intro_to_data/figures/eoce/bimodalHistBox/bimodalHistBox}
\end{center}
}{}
...
\begin{center}
\includegraphics[width=0.9\textwidth]{ch_intro_to_data/figures/eoce/marathon/marathon_histBox}
\end{center}
\begin{parts}
...
\begin{center}
\includegraphics[width=0.7\textwidth]{ch_intro_to_data/figures/eoce/marathon/marathon_genderBox}
\end{center}
...
\end{parts}
\begin{center}
\includegraphics[width=0.95\textwidth]{ch_intro_to_data/figures/eoce/marathon/marathon_genderTimeSeries} \\
\end{center}
}{}
...
\includegraphics[width=\textwidth]{ch_intro_to_data/figures/eoce/salary/salary}
\end{minipage}
\begin{minipage}[c]{0.4\textwidth}
\begin{center}
\begin{tabular}{rrr}
...
\begin{center}
\includegraphics[width=\textwidth]{ch_intro_to_data/figures/eoce/county/county_workTravelHist}
\end{center}
\end{minipage}
...
\begin{center}
\includegraphics[width=0.49\textwidth]{ch_intro_to_data/figures/eoce/county/county_hispHist}
\includegraphics[width=0.49\textwidth]{ch_intro_to_data/figures/eoce/county/county_hispHistLog}
\end{center}
}{}
...
\begin{center}
\includegraphics[width=\textwidth]{ch_intro_to_data/figures/eoce/county/county_workTravelMap}
\end{center}
}{}
...
\begin{center}
\includegraphics[width=\textwidth]{ch_intro_to_data/figures/eoce/county/county_hispMap}
\end{center}
\begin{parts}
...
\end{parts}
\includegraphics[width = 0.6\textwidth]{ch_intro_to_data/figures/eoce/tracheitis/tracheitis_bar}
\includegraphics[width = 0.35\textwidth]{ch_intro_to_data/figures/eoce/tracheitis/tracheitis_pie}
}{}
...
\begin{minipage}[c]{0.5\textwidth}
\begin{center}
\includegraphics[width = 0.85\textwidth]{ch_intro_to_data/figures/eoce/dreamAct/dreamAct_mosaic}
\end{center}
...
\end{parts}
\begin{center}
\includegraphics[width= 0.48\textwidth]{ch_intro_to_data/figures/eoce/heartTr/heartTr_SurvTrMosaic}\ 
\includegraphics[width = 0.48\textwidth]{ch_intro_to_data/figures/eoce/heartTr/heartTr_SurvTimeTrBox}
\end{center}
}{}
...
\end{parts}
\begin{center}
\includegraphics[width = 0.75\textwidth]{ch_intro_to_data/figures/eoce/heartTr/heartTr_RandHist} \\
\end{center}
}{}
...
\end{subparts}
\begin{center}
\includegraphics[width = 0.75\textwidth]{ch_intro_to_data/figures/eoce/avandia/avandia_RandHist} \\
\end{center}
\end{parts}
}{}
