...
\eoce{\qt{Sinusitis and antibiotics, Part I\label{sinusitis_and_antibiotics_intro}} 
...
\hfill\includegraphics[width = 0.78\textwidth]{ch_intro_to_data/figures/eoce/internet_life_expactancy/internet_life_expactancy.pdf}
\end{minipage}
}{}
...
dementia, including 1,136 with AlzheimerÕs disease and 416 with vascular 
...
\begin{minipage}[c]{0.55\textwidth}
\begin{center}
\includegraphics[width = 0.78\textwidth]{ch_intro_to_data/figures/eoce/mammal_life_spans/mammal_life_spans_scatterplot.pdf}
\end{center}
\end{minipage}
}{}
...
\hfill\includegraphics[width = 0.9\textwidth]{ch_intro_to_data/figures/eoce/association_plots/association_plots.pdf}
\end{minipage}
}{}
...
\begin{center}
\includegraphics[width=0.97\textwidth]{ch_intro_to_data/figures/eoce/hist_box_match/hist_box_match.pdf}
\end{center}
}{}
...
\end{parts}
\begin{center}
\includegraphics[width=0.73\textwidth]{ch_intro_to_data/figures/eoce/marathon_winners/marathon_winners_time_series.pdf} \\
\end{center}
}{}
...
\begin{center}
\includegraphics[width = 0.65\textwidth]{ch_intro_to_data/figures/eoce/dream_act_mosaic/dream_act_mosaic.pdf}
\end{center}
}{}
...
\begin{center}
\includegraphics[width = 0.65\textwidth]{ch_intro_to_data/figures/eoce/raise_taxes_mosaic/raise_taxes_mosaic.pdf}
\end{center}
}{}
...
\item What do the box plots below suggest about the efficacy (effectiveness) of 
