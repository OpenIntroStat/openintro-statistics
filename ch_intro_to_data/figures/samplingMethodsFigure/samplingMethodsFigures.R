...
myPDF("simple_systematic.pdf",  5.9, 6,
...
myPDF("stratified_cluster_multistage.pdf", 5.9, 9,
      mar=rep(0.5,4), mfrow=c(3,1))
...
# _____ Cluster _____ #
PCH <- rep(c(1, 3, 20)[3], 3)
plot(0, xlim=c(0,2), ylim = c(0, 1.03), type='n', axes=FALSE)
box()
