...
%
%\noindent%
%	OpenIntro Statistics covers a first course in statistics, providing a rigorous introduction to applied statistics that is clear, concise, and accessible.
%	This book was written with the undergraduate level in mind, but it's also popular in high schools and graduate courses.
...
\noindent%
	...
	\begin{description}
		...
		Regresija za kvantitativne i kvalitativne podatke uz korištenje više nezavisnih varijabli. %for an accelerated course.
	\end{description}%%
\noindent%
