...
\titleformat{\chapter}
{}
{\setupfont{}\setfontsize{\chapterXfontsize}\color{oiB}Glava~\thechapter}% \quad #1}
{1em}
{}
[]%
...
\newcommand{\chapterintro}[1]{
  ...
  \noindent%
  \oiRedirect{os}{\includegraphics[height=10mm]{extraTeX/icons/video_and_slides.png}}
  \vspace{5mm}
...
% Croatian
\Large\noindent%
Video zapise, prezentacije i druge resurse na engleskom jeziku možete naći na
internetskim stranicama \\[2mm]
...
\titleformat{\section}
    ...
    {\color{oiB}\thesection \quad %#1} ovdje je originalno bilo #1
    }
    {1em}
    {#1} % premjestila #1 ovdje da prelama dugi naslov u novi red - radi
...
% Croatian
\newcommand{\reviewexercisesheader}[1][Vježbe uz poglavlje]
{
	\clearpageforsection
...
% Croatian
\newcommand{\exercisesheader}[1][Vježbe]
{
	\clearpageforsection
