...
{\color{oiB}\normalfont\large\bfseries\Large}%\MakeUppercase}
...
{\begin{itemize}
\item[\color{oiB}\Large$\CIRCLE$]\refstepcounter{equation}\noindent\textbf{\color{oiB}Example \theexample}%\hspace{0.3cm}
...
\newcommand{\exampleicon}[1]{\vspace{#1} \raggedleft\includegraphics[width=5mm]{extraTeX/icons/example}\hspace{2mm}\ }
\newenvironment{gpewrapper}[2][5mm]{\addvspace{4mm}

%\ifthenelse{\isodd{\value{page}}}{\reversemarginpar}{\normalmarginpar}

%\marginpar[\exampleicon{#1}]{\exampleicon{#1}}
\noindent\hspace{-4.2mm}\begin{minipage}[b]{\textwidth+7.75mm}\begin{mdframed}[%
    topline=false,
    rightline=false,
    bottomline=false,
    linewidth=0.5mm,
    linecolor=oiB]}{\end{mdframed}\end{minipage}

    \addvspace{4mm}}
\newenvironment{examplewrap}[1][5mm]
    {\begin{gpewrapper}[#1]{}}
    {\end{gpewrapper}}
\newenvironment{exercisewrap}[1][5mm]
    {\begin{gpewrapper}[#1]{}}
    {\end{gpewrapper}}
% 9.2.3 Example Title
