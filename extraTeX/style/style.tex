...
\thechapter}{20pt}{{\Huge #1}}
% 5.2 Section
\newcommand{\sectionheaderspaceA}{1mm}
\let\oldsection\section
\renewcommand\section{\clearpage\oldsection}
\titleformat{\section}
    {{\color{oiR}\titlerule[1mm]}\addvspace{\sectionheaderspaceA}\color{oiB}\normalfont\LARGE\bfseries%
        \fontfamily{phv}%
        \selectfont}
...
\hspace{0.5mm}\includegraphics[width=5mm]{extraTeX/icons/#1}
