...
\eocesol{\includegraphics[width = 40mm]{ch_intro_to_data/figures/eoce/reproducing_bacteria/reproducing_bacteria_sketch.pdf}}
...
(b)~\includegraphics[width=40mm]{ch_probability/figures/eoce/swing_voters/swing_voters.pdf}
...
\eocesol{(a)~
\includegraphics[width=40mm]{ch_probability/figures/eoce/tree_drawing_box_plots/tree_drawing_box_plots}
(b)~0.84}

% 23

\eocesol{0.8247. \includegraphics[width=40mm]{ch_probability/figures/eoce/tree_hiv_swaziland/tree_hiv_swaziland.pdf}}
...
\eocesolch{{\color{red}CHAPTER 4 IS NOT YET ENTERED}}
...
% 17
\eocesol{(a)~Since itÕs the same students at the beginning and the end of the semester, there is a pairing between the datasets, for a given student their beginning and end of semester grades are dependent.
(b)~Since the subjects were sampled randomly, each observation in the menÕs group does not have a special correspondence with exactly one observation in the other (womenÕs) group.
(c)~Since itÕs the same subjects at the beginning and the end of the study, there is a pairing between the datasets, for a subject student their beginning and end of semester artery thickness are dependent.
(d)~Since itÕs the same subjects at the beginning and the end of the study, there is a pairing between the datasets, for a subject student their beginning and end of semester weights are dependent.}
