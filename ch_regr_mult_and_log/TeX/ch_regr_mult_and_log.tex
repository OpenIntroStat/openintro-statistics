...
\begin{nexample}{Construct a model for the \data{loans} data
  ...
  variable.
  That is, we fit the model including just \var{ver\us{}income},
  ...
  \end{tabular}
  \end{center}
  The model adding \var{ver\us{}income} improved adjusted $R^2$
  (0.24183 to 0.20046), so we add \var{ver\us{}income} to the
  model.

  We continue on in this way,
  next adding \var{debt\us{}to\us{}income},
  then \var{credit\us{}checks},
  and \var{past\us{}bankr}.
...
\end{nexercise}
\end{exercisewrap}
\footnotetext{The \var{past\us{}bankr} predictor is up for
...
\begin{nexample}{Results corresponding to the full model
    for the \data{mario\us{}kart} data were shown
...
\index{multiple regression!technical conditions|(}
\index{multiple regression!conditions|(}
...
\Comment{Still must update the next equation.}
\begin{align*}
\widehat{rate} &= \ 1.921
    + 0.974 \times \indfunc{ver\us{}income}{source\us{}only}
    + 2.535 \times \indfunc{ver\us{}income}{verified} \\
...
\item[Normal probability plot.]
    ...
    in Figure~\ref{loansDiagNormalQuantilePlot}.
    While the plot exhibits some minor irregularities,
    they are very mild.
    In a normal probability plot for residuals,
    we tend to be most worried about residuals that appear
    to be outliers, since these indicate long tails in the
    distribution of residuals.
    Additionally, if there is a lot of data, normality
...
\begin{figure}[h]
  ...
  \Figures{0.55}
      {loansDiagnostics}
      {loansDiagNormalQuantilePlot}
  \caption{A normal probability plot of the residuals.}
  \label{loansDiagNormalQuantilePlot}
\end{figure}
...
\item[Normal probability plot.]
    ...
    Figure~\ref{mkDiagnosticNormalQuantilePlot}.
    While the plot exhibits some minor irregularities,
    there are no outliers that might be cause for concern.

\begin{figure}[h]
  \centering
  \Figures{0.55}{marioKartDiagnostics}
...
\begin{figure}
  \centering
  \Figures{0.55}{marioKartDiagnostics}{mkDiagnosticEvsAbsF}
...
\begin{figure}[h]
  \centering
  \Figures{0.5}{marioKartDiagnostics}{mkDiagnosticInOrder}
...
\begin{figure}
  \centering
  \Figures{0.75}{marioKartDiagnostics}{mkDiagnosticEvsVariables}
...
The coefficient of \var{racewhite} in the full model in
Figure~\ref{resumeLogisticModelResults},
