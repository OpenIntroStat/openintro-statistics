...
\begin{nexample}{How would we write an equation for
  ...
  \widehat{rate} = 11.10 +
      1.42 \times
          %1_{\var{income\us{}ver} = \resp{source\us{}only}} +
          \indfunc{income\us{}ver}{source\us{}only} +
      3.25 \times
          %1_{\var{income\us{}ver} = \resp{verified}}
...
\index{multiple regression!model conditions|(}
...
The \data{mario\us{}kart} data set includes results
from \mknum{}~auctions.
...
\begin{tabular}{rrrrlr}
  ...
  \hline
\end{tabular}
\caption{Four observations from the \data{mario\us{}kart}
    data set.}
...
\begin{figure}[h]
  \centering
  \Figures{0.65}{marioKartDiagnostics}
      {mkDiagResHist}
...
\begin{figure}
  \centering
  \Figures{0.7}{marioKartDiagnostics}{mkDiagnosticEvsAbsF}
...
\begin{figure}[h]
  \centering
  \Figures{0.7}{marioKartDiagnostics}{mkDiagnosticInOrder}
