...
\Comment{This section especially will require a careful
    review from an outside group that specializes in the
...
\begin{nexample}{Let's consider a gender-imbalanced
    ...
    men or women?}
  \index{gender_imbalance_leads_to_discrimination}%
