...
We want to construct a model that accounts for not only the game condition, as in Section~\ref{ind_and_cat_vars_as_predictors}, but simultaneously accounts for three other variables: \var{stock\us{}photo}, \var{duration}, and \var{wheels}.
\begin{align}
\widehat{\var{price}}
