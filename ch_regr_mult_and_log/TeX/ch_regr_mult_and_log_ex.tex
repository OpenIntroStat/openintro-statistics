...
audiences love or hate a movie. She collects a random sample of movies (genre, length, 
...
which variables are significant predictors of movie success, what type of model selection
...
rated previously watched movies, etc.). The recommendation system will be deemed successful if
...
\eoce{\qt{Possum classification, Part I} \label{possumClassification1} The common brushtail possum of the Australia region is a bit cuter than its distant cousin, the American opossum (see Figure~\vref{brushtail_possum}). We consider 104 brushtail possums from two regions in Australia, where the possums may be considered a random sample from the population. The first region is Victoria, which is in the eastern half of Australia and traverses the southern coast. The second region consists of New South Wales and Queensland, which make up eastern and northeastern Australia.
...
\eoce{\qt{Possum classification, Part II} A logistic regression model was proposed for classifying common brushtail possums into their two regions in Exercise~\ref{possumClassification1}. The outcome variable took value 1 if the possum was from Victoria and 0 otherwise.
\begin{center}
