...
%_______________
\newpage\subsection*{Exercises} % Confidence intervals
...
\item
    ...
    fraction of first-time visitors the site designers can expect
    will register under the new design
...
in the mail.
(As always, be sure to check any necessary conditions along the way.)
}{}
