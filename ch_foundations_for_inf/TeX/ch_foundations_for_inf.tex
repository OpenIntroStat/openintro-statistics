...
understanding the accuracy of parameter estimates.
...
%\oiRedirect{textbook-pew_2018_poll_on_solar_and_wind_expansion}{www.pewinternet.org/2018/05/14/majorities-see-government-efforts-to-protect-the-environment-as-insufficient} [Make sure the redirect link actually works.]}
...
\caption{Code for a single $\hat{p}$ simulation using the
...
\begin{onebox}{How to verify sample observations are independent}
  ...
  get using more advanced methods.\vspace{3mm}
...
This more precise value
is typically what is typically used to construct a
...
the Roslings have several such questions similar
...
\begin{onebox}{Checking success-failure and computing
  ...
  null hypothesis is true when we compute the p-value,
