...
\#\ \ \ \ and 11\% are "not". \\
pop\_size <- 250000000 \\
possible\_entries <- c(rep("support", \pewsolarpollprop{}*pop\_size), rep("not", \pewsolarpollpropcomplement{}*pop\_size))\\
\# 2.\ Sample \pewsolarpollsize{} of the entries. \\
sampled\_entries <- sample(possible\_entries, \pewsolarpollsize{}) \\
\# 3.\ Count the number that are "support", then divide
by the sample size. \\
