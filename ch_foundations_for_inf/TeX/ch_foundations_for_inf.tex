...
(pronounced \emph{p-hat}\footnote{Not to be confused with
  ...
  like this book.}).
\Comment{Joke in the footnote okay?}
...
%the error error in a sample's estimate can be influenced
...
\begin{figure}
   \centering
   \Figure{0.8}{sampling_10k_prop_88p}
...
a bigger sample tends to provide a more precise point estimates
