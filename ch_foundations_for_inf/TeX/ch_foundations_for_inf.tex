...
\chapterintro{Statistical inference is primarily concerned
  with understanding the uncertainty of parameter estimates.
...
\begin{enumerate}[(a)]
\item
    Is a normal approximation reasonable for the proportion
...
\begin{exercisewrap}
\begin{nexercise}
Consider the 90\% confidence interval from the solar
energy survey, which was 87.1\% to 90.4\%.
...
\footnotetext{
  ...
  It does not describe what we might observe for future point
  estimates.}
