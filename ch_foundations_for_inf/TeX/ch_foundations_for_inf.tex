...
\item[Success-failure condition.] To check this condition,
    ...
    a reasonable substitute, and each value is well
...
identify that the normal distribution might not be appropriate.
...
Support for expanding wind turbines received support
from \pewwindpollpercent{}\% of the \pewwindpollsize{}
respondents.\footnotemark{}
\begin{enumerate}[(a)]
\item
...
\footnotetext{(a)~We
  ...
  confirmed that that $\hat{p}$ closely follows
...
\roslingBcount{} (\roslingBpercent{}) selected the correct answer to the
question in Guided
