...
\item Question 3.
    ...
    \end{enumerate}
\end{enumerate}
Write down what your answers (or guesse) are to each question,
and when you're ready to learn the answers, look in the
footnote.\footnote{1 - X. 2 - X. 3 - X.}

When looking at a larger sample of people who answer these questions,
you'll find that some of these questions are harder than others:
the fraction of people who get the correct answer varies dramatically
from one question to the next.

As we work through this question, we'll be exploring how people
perform on these questions, and we'll aim to make conclusions
about the general understanding of college educated individuals
on these particular topics.




Rosling has asked folks with a college degree these questions
to see how they perform, and ultimately there are three scenarios.
\begin{itemize}
\item On the other hand, perhaps folks with college degrees
    simply never learn these particular topics and their
    responses are simply equivalent to random guesses.
\item These folks have knowledge that helps them do better
...
%of \$85~billion in the stock market. His net worth is
%more than the gross domestic product of dozens of countries.
%As perhaps the most thoughtful investor of our time, Buffett
...
%rates of return than index funds.
%It would be helpful to test that theory!
%We'll look at a sample of managed funds
...
population proportion is different from 50\%?
