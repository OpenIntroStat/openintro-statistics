...
retailer in the suburbs between 2pm and 3pm each afternoon
is 6.5, and the number that show up on any given day follows
...
\item
    ...
    flights it makes, and the CEO ask you if it
    is still reasonable to use the Poisson
    model with a mean of 2.2.
