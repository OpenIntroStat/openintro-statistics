...
\textbf{\color{red}Confirm solutions are correct. E.g. may have removed last part.}
...
\item
    ...
    75 inches?
\item\label{heights_10_yrs_dist_75_inches}
    If there are 2,000 10 year olds entering
    Six Flags Magic Mountain in a single day,
    then compute the expected number of
    10 year olds who are at least 75 inches tall.
\item
    Using the binomial distribution,
    compute the probability that 0 of the 2,000
    10 year olds will be at least 75 inches tall.
\item
    The number of 10 year olds who enter
    Six Flags Magic Mountain and are
    at least 75 inches tall in a given day
    follows a Poisson distribution with
    mean equal to the value you found in
    part~(\ref{heights_10_yrs_prob_75_inches}).
    Use the Poisson distribution to identify
    the probability no 10 year old will enter
    the park who is 75 inches or taller.
%    Suppose Batman figurine was restricted to the 5th
%    10 year old entering the park who was also tall
%    enough to ride \emph{Batman the Ride}.
%    What are the chances that the 10 year old who receives
%    the figuring
\end{parts}
}{}
