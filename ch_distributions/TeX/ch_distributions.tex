...
\footnotetext{We found the probability in
  ...
  \Figures{0.18}{subtractingArea}{subtracted}}
...
The \term{geometric distribution} is used to describe how
...
\term{geometric distribution}, which describes the waiting
