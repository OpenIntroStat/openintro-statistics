...
%_________________
\section[Normal distribution]{Normal distribution \sectionvideohref{youtube-S_p5D-YXLS4&list=PLkIselvEzpM6V9h55s0l9Kzivih9BUWeW}}
\label{normalDist}
...
%_________________
\section[Evaluating the normal approximation]{Evaluating the normal approximation \sectionvideohref{youtube-smJBsZ4YQZw&list=PLkIselvEzpM6V9h55s0l9Kzivih9BUWeW}}
...
\section[Binomial distribution (special topic)]{Binomial distribution (special topic) \sectionvideohref{youtube-tKmyzhvgudw&list=PLkIselvEzpM6V9h55s0l9Kzivih9BUWeW} \sectionvideohref{youtube-VvksxAZAlrQ&list=PLkIselvEzpM6V9h55s0l9Kzivih9BUWeW}}
\label{binomialModel}
