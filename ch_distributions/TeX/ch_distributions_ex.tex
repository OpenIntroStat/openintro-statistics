...
\item Explain why simply comparing her raw scores from the two sections would 
lead to the incorrect conclusion that she did better on the Quantitative 
Reasoning section.
...
question and part (a) of Exercise~\ref{tempLA}? Are you surprised? Explain.
...
considered an independent Bernouilli trial for the following situations.
\begin{parts}
...
\eoce{\qt{Exploring combinations\label{explore_combinations}} The formula for the 
...
\eoce{\qt{Stenographer's typos, Part I\label{stenographer_typos}} A very skilled 
