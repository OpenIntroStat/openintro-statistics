...
histPlot(pHat, breaks=(-1:(2*M)+0.75)/2/n, xlab=expression(hat(p)[sim]*"    "), col="#E2E2E2", ylab="", axes=FALSE)
axis(1)
...
histPlot(pHat[pHat >= 0.40], breaks=(-1:(2*M)+0.75)/2/n, col=oiB, add=TRUE)
