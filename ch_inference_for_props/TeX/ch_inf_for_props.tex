...
In general, small sample methods produce more accurate results since they rely on fewer assumptions. However, they often require some extra work or simulations. For this reason, many data scientists use small sample methods only when conditions for large sample methods are not satisfied.
