...
\item If you found $\chi^2 = 10$ with $df = 5$ you would fail to reject $H_0$ at the 5\% significance level.
...
%__________________
\subsection{Randomization test (special topic)}
...
\begin{parts}
\item What are the hypotheses for testing if yawning is contagious, i.e. whether it is more likely for someone to yawn if they see someone else yawning?
