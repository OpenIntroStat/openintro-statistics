...
We've spent a lot of times discussing conditions for when
...
For folks wanting to use the table option, we provide an outline
of how to read the chi-square table in
