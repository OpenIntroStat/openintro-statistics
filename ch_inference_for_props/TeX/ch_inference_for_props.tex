...
follows a normal distribution by checking certain conditions.
...
\text{point estimate} \pm z^{\star} \times SE
\end{align*}
As with a single proportion context,
...
\begin{nexample}{We consider an experiment for patients
  ...
  each experiment arm.
  With these conditions met, a normal distribution can be used
