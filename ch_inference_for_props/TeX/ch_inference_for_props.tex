...
{Difference of two proportions}% \sectionvideohref{youtube-_iFAZgpWsx0&feature=youtu.be&t=517&list=PLkIselvEzpM5Gn-sHTw1NF0e8IvMxwHDW}~\sectionslideshref{gdoc_os3_slides_6-2}}
...
\begin{termBox}{\tBoxTitle{Conditions for the
...
\begin{example}{We consider an experiment for patients
...
\begin{termBox}{
  \tBoxTitle{Computing degrees of freedom for a two-way table}
