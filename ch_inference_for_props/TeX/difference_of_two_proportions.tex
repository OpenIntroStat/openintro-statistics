...
\eoce{\qt{National Health Plan, Part III\label{national_health_plan_CI_replaced}}
\textbf{\color{red}ADD SOLUTION.}
Exercise~\ref{national_health_plan_HT}
presents the results of a poll evaluating support for
a National Health Plan in the United States.
...
\item
    ...
    $(p_{D} - p_{I})$ and interpret it in this context.
