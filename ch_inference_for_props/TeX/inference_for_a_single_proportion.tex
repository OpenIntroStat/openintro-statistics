...
surveyed.\footfullcite{news:KFF2019_nat_health_plan}
\begin{parts}
\item
...
\textbf{\color{red}ADD SOLUTION.}
Exercise~\ref{national_health_plan_HT} presents the results of
a poll evaluating support for a National Health Plan in the US
in 2019, reporting that 55\% of Independents in the sample support
the public option.
