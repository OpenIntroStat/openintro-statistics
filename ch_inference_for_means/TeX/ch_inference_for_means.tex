...
\begin{figure}
\centering
\includegraphics[width=0.9\textwidth]{ch_inference_for_means/figures/textbooksS10/diffInTextbookPricesS10}
...
\begin{exercise}
The first difference shown in Figure~\ref{textbooksDF} is computed as $27.67-27.95=-0.28$. Verify the differences are calculated correctly for observations~2 and~3.\footnote{Observation 2: $40.59 - 31.14 = 9.45$. Observation 3: $31.68 - 32.00 = -0.32$.}
\end{exercise}
...
\begin{align*}
T = \frac{\bar{x}_{\text{\emph{diff}}} - 0}{SE_{x_{\text{\emph{diff}}}}} = \frac{12.76 - 0}{1.67} = 7.65
\end{align*}
