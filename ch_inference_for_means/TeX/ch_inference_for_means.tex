...
\begin{figure}
  \centering
  \Figure{0.5}{tDistCompareToNormalDist}
...
a graphing calculator or a \term{t-table};
...
\end{nexercise}
\end{exercisewrap}
\footnotetext{(a)~The difference in sample means is an appropriate point estimate: $\bar{x}_{n} - \bar{x}_{s} = 0.40$. (b)~The standard error of the estimate can be estimated using the standard error formula:
\begin{align*}
SE
