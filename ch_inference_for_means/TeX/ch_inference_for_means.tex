...
\begin{figure}[h]
\centering
\includegraphics[width=0.75\textwidth]{ch_inference_for_means/figures/rissosDolphin/rissosDolphin.jpg}  \\
\addvspace{2mm}
...
\begin{figure}
\centering
\includegraphics[width=0.85\textwidth]{ch_inference_for_means/figures/textbooksS10/diffInTextbookPricesS10}
...
\begin{center}
\includegraphics[width=0.56\textwidth]{ch_inference_for_means/figures/distOfDiffOfSampleMeansForBWOfBabySmokeData/distOfDiffOfSampleMeansForBWOfBabySmokeData}
\end{center}
\end{example}
...
\begin{center}
\includegraphics[width=0.75\textwidth]{ch_inference_for_means/figures/power_null_0_1-7/power_null_A_0_1-7}
\end{center}
\end{example}
...
\begin{center}
\includegraphics[width=0.75\textwidth]{ch_inference_for_means/figures/power_null_0_1-7/power_null_B_0_1-7_with_rejection_region}
\end{center}
\end{example}
