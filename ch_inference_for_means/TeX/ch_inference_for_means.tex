...
\section[One-sample means with the $t$-distribution]{One-sample means with the $t$-distribution \sectionvideohref{coursera_video-t_distribution} \sectionvideohref{coursera_video-inf_for_mean}}
...
%__________________
\section[Paired data]{Paired data \sectionvideohref{coursera_video-inf_paired_means}}
\label{pairedData}
...
%__________________
\section[Difference of two means]{Difference of two means \sectionvideohref{coursera_video-inf_two_means}}
...
%__________________
\section[Power calculations for a difference of means (special topic)]{Power calculations for a difference of means\\ (special topic) \sectionvideohref{coursera_video-power}}
...
%__________________
\section[Comparing many means with ANOVA (special topic)]{Comparing many means with ANOVA\\(special topic) \sectionvideohref{coursera_video-anova_intro} \sectionvideohref{coursera_video-anova_conditions} \sectionvideohref{coursera_video-mult_comparison}}
