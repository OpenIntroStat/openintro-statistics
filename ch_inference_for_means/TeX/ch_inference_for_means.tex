...
\item[Normality.]
    ...
    \Comment{I'm a bit torn on this condition.
    It's not reasonable for this to refer
    to the sampling distribution itself, since
    that is also contingent on the independence
    of observations, but we're also not requiring
    normality in all cases.
    I was tempted to label it the
    ``normality / sample size'' condition.
    Or maybe the ``distribution'' condition.
    Thoughts here are welcome and appreciated.}
\end{description}
