...
\begin{center}
\includegraphics[width=0.45\textwidth]{ch_inference_for_means/figures/eoce/hsb2/hsb2_read_write_box}
\includegraphics[width=0.51\textwidth]{ch_inference_for_means/figures/eoce/hsb2/hsb2_diff_hist}
\end{center}
\begin{parts}
...
\begin{center}
\includegraphics[width=\textwidth]{ch_inference_for_means/figures/eoce/workDeg/workDeg_work_edu_hist}
\end{center}
\end{minipage}
...
\begin{center}
\includegraphics[width=0.9\textwidth]{ch_inference_for_means/figures/eoce/ncbirths/ncbirths_hist}
\end{center}
}{}
...
\begin{minipage}[c]{0.6\textwidth}
\begin{center}
\includegraphics[width=0.63\textwidth]{ch_inference_for_means/figures/eoce/fuelEff/fuelEff_hist_hwy}
\end{center}
\end{minipage}
}{}
...
\begin{center}
\includegraphics[width=0.9\textwidth]{ch_inference_for_means/figures/eoce/prison/prison_qq} \\
$\:$ \\
...
\begin{center}
\includegraphics[width=0.8\textwidth]{ch_inference_for_means/figures/eoce/gpaMajor/gpaMajor_box}
\end{center}
\begin{center}
\begin{tabular}{lrrrrr}
  \hline
