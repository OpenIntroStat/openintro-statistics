...
\begin{figure}[bth]
  ...
  \caption{A histogram of \var{interest\_\hspace{0.3mm}rate}.
...
\begin{figure}
  ...
  \caption{\subref{county_pop_change_v_pop_transform_i}
      Scatterplot of \var{line\_\hspace{0.3mm}breaks}
      against \var{num\_\hspace{0.3mm}char} for 50 emails.
...
\caption{A contingency table with row proportions
    for the \var{app\_\hspace{0.3mm}type} and
