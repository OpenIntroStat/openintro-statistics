...
{book}
\newcommand{\versiondate}[0]{Oct 21st, 2022}
...
%\PassOptionsToPackage{hyperref}{colorlinks=false,pdfborder={0 0 0},urlcolor= black,colorlinks=black,linkcolor=black, citecolor=black,backref=true}
