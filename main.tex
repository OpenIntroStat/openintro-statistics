...
\usepackage{
  amsmath, calc, caption, changepage,
  endnotes, enumerate, epstopdf,
  fancyhdr, footmisc,
  geometry, graphicx, ifthen, lscape,
  makeidx, multicol, multirow, setspace,
  soul, subfigure, textcomp, titlesec,
  varioref, verbatim, wasysym, wrapfig
}
