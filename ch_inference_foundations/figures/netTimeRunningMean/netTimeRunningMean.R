...
# run10Samp <- run10[temp,c("time", "age", "gender", "state")]
# run10Samp$time <- run10Samp$time + 0.09
...
plot(xBars, type = "l", axes = FALSE,
     xlab = "", ylab = "Running mean (minutes)",
     col = COL[1], lwd = 2, ylim = c(85, 100))
