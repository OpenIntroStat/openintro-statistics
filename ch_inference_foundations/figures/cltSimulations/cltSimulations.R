...
par(mar=c(3, 1, 0, 1))
plot(X, Yu, type='s', xlab='', ylab='',
     xlim=c(-2, 6), ylim=c(0, 0.75),
     axes=FALSE, col=COL[1], lwd=2)
text(1, 0.77, 'uniform', pos=1, cex=1.7)
axis(1, at=seq(-2, 6, 2), cex.axis=cex.axis)
abline(h=0)

plot(X, Ye, type='l', xlab='', ylab='',
     xlim=c(-2, 6), ylim=c(0, 83/60),
     axes=FALSE, col=COL[1], lwd=2)
text(1, 86/60, 'exponential', pos=1, cex=1.7)
axis(1, at=seq(-2, 6, 2), cex.axis=cex.axis)
abline(h=0)

plot(X, Yl, type='l', xlab='', ylab='',
     xlim=c(-2, 6), ylim=c(0, 83/60),
     axes=FALSE, col=COL[1], lwd=2)
