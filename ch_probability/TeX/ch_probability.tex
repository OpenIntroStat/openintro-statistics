...
\chapterintro{Probability forms a foundation of statistics,
  ...
  aware of many of the ideas.
  However, formalization of the concepts is new for most.
  This chapter aims to introduce probability concepts
...
\includegraphics[width=0.7\textwidth]{ch_probability/figures/treeDiagramAndPass/treeDiagramAndPass}}% \vspace{-25mm}
%\end{minipage}}
...
\Figure{}{treeDiagramGarage}\vspace{-45mm}
\end{minipage}}
