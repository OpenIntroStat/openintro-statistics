...
\Add{The foundation of statistics is in probability,
and while it is possible to do a lot of applied statistics
without probability, the ideas in this chapter form
a foundation for a deeper understanding and for later courses.}
