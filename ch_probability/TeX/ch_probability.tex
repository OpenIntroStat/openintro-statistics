...
\begin{align*}
P(\text{\var{mach\us{}learn} = \resp{pred\us{}fashion}})
    = \frac{\fashYA{}}{\fashN{}}
    = 0.12
\end{align*}
...
& \var{parents}: \resp{degree} & \var{parents}: \resp{not} & Total  \\
  \hline
\var{teen}: \resp{college}     & 0.11 & 0.01 & 0.12 \\
\var{teen}: \resp{not} \hspace{0.5cm} & 0.06 & 0.82 & 0.88  \\
   \hline
...
Joint outcome & Probability \\
  \hline
\var{mach\us{}learn} = \resp{pred\us{}fashion}
    and \var{truth} = \resp{fashion} & 0.11 \\
\var{mach\us{}learn} = \resp{pred\us{}fashion}
    and \var{truth} = \resp{not} & 0.01 \\
\var{mach\us{}learn} = \resp{pred\us{}not}
    and \var{truth} = \resp{fashion} & 0.06 \\
\var{mach\us{}learn} = \resp{pred\us{}not}
    and \var{truth} = \resp{not} & 0.82 \\
   \hline
Total & 1.00 \\
\hline
\end{tabular}
...
\footnotetext{Each of the four outcome combination are disjoint,
   ...
   the probabilities is $0.11 + 0.01 + 0.06 + 0.82 = 1.00$.}
...
\newcommand{\ultruthfashion}[0]
    {\underline{\var{truth} = \resp{fashion}}}%
\begin{align*}
P(\text{\ultruthfashion{}})
  &= P(\text{\var{mach\us{}learn} = \resp{pred\us{}fashion}
        and \ultruthfashion{}}) \\
    & \qquad + P(\text{\var{mach\us{}learn} = \resp{pred\us{}not}
        and \ultruthfashion{}}) \\
  &= 0.11 + 0.06 \\
  &= 0.17
\end{align*}
...
We considered only those cases that satisfied the condition, \var{parents} \resp{degree}. Of these cases, the conditional probability was the fraction who represented the outcome of interest, \var{teen} \resp{college}. Suppose we were provided only the information in Figure~\ref{photoClassifyProbTable}, i.e. only probability data. Then if we took a sample of 1000 people, we would anticipate about 35\% or $0.35\times 1000 = 350$ would meet the information criterion (\var{parents} \resp{degree}). Similarly, we would expect about 29\% or $0.29\times 1000 = 290$ to meet both the information criteria and represent our outcome of interest. Then the conditional probability can be computed as
\begin{align}
&P(\text{\var{teen} \resp{college}}\ |\ \text{\var{parents} \resp{degree}}) \notag \\
...
(b)~Determine the probability from part (a). Table~\vref{photoClassifyProbTable} may be helpful.\footnotemark
\end{nexercise}
\end{exercisewrap}
