...
\eoce[\MarginVideo{ahss_eoce_sol-four_games_one_winner}]{\qt{Four games, one winner\label{four_games_one_winner}} Below are four 
...
\eoce[\MarginVideo{ahss_eoce_sol-swing_voters}]{\qt{Swing voters\label{swing_voters}} A 2012 Pew Research survey asked 2,373 
...
\eoce[\MarginVideo{ahss_eoce_sol-global_warming}]{\qt{Global warming\label{global_warming}} A 2010 Pew Research poll asked 
...
\eoce[\MarginVideo{ahss_eoce_sol-tree_lupus}]{\qt{It's never lupus\label{tree_lupus}} Lupus is a medical phenomenon where 
...
\eoce[\MarginVideo{ahss_eoce_sol-student_outfits}]{\qt{Student outfits\label{student_outfits}} In a classroom with 24 
...
\eoce{\qt{Hearts win\label{hearts}} In a new card game,
you start with a well-shuffled full deck and draw 3 cards without replacement.
...
\eoce{\qt{Scooping ice cream\label{scoop_ice_cream}} Ice cream usually comes in
1.5~quart boxes (48 fluid ounces), and ice cream scoops hold about 2 ounces. 
